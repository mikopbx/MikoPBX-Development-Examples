<form method="post" action="module-example-ami/module-example-ami/save" role="form" class="ui large form" id="module-example-ami-form">
    {{ form.render('id') }}
    ...
    {{ partial("partials/submitbutton",['indexurl':'module-example-ami/module-example-ami/index']) }}
</form>