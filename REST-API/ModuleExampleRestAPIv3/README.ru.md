...
Этот модуль демонстрирует **Pattern 3 (Авто-обнаружение)** - рекомендуемый подход к созданию REST API endpoints в MikoPBX с использованием атрибутов PHP 8.4 и автоматического обнаружения контроллеров.
